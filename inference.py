        ...
        try:
            ...
            for i, chunk in enumerate(chunks):
                ...
                with torch.no_grad():
                    ...
                    # Use the correct key for conditioning model (from config.yaml)
                    cond_key = list(self.model.cond_stage_models.keys())[0]  # Get first key
                    cond_tensor = self.model.cond_stage_models[cond_key](log_mel)
                    cond = {cond_key: cond_tensor}
